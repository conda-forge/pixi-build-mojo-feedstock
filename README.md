About pixi-build-mojo-feedstock
===============================
...
Documentation: https://pixi.prefix.dev/latest/build/backends/pixi-build-mojo/
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pixi-build-mojo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pixi-build-mojo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pixi-build-mojo
# for installing globally
pixi global install pixi-build-mojo
```
...
It is possible to list all of the versions of `pixi-build-mojo` available on your platform:
...
```
pixi search pixi-build-mojo --channel conda-forge
```
